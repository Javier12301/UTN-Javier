# Desarrollar programa que permita procesar datos
# de una pequeña pobalción

"""
    Requerimiento:
    1. cada habitante se le ingresa M/F y edad
    2. carga de datos finaliza al ingresar cualquier otro valor
    para seleccionar sexo.

    Informar:
    a. que sexo corresponde la mayor cantidad de habitantes
    b. cantidad de mujeres en edad escolar (4 a 18 años)
    c. si hay algun varón que supere 80 años de edad
"""
